  ...
  const skillCategories = [
    {
      ...
      skills: [
        { name: 'HTML/CSS', level: 90, description: 'Semantic HTML and modern CSS including Flexbox, Grid, and animations' },
        { name: 'JavaScript', level: 80, description: 'ES6+, DOM manipulation, async programming' },
        { name: 'React', level: 75, description: 'Component architecture, state management, Vue Router' },
        { name: 'TypeScript', level: 70, description: 'Hooks, Context API, Redux, Next.js' },
        { name: 'Angular', level: 40, description: 'Real-time UI updates, dynamic interfaces' },
      ],
    },
    {
      name: 'Backend',
      ...
      skills: [
        { name: 'Python', level: 80, description: 'Django, Flask, RESTful APIs, web scraping' },
        { name: 'PostgreSQL', level: 75, description: 'Database design, queries, transactions' },
        { name: 'NodeJs', level: 75, description: 'Express, RESTful APIs, websockets, JWT' },
        { name: 'C#', level: 65, description: 'ASP.NET Core, Entity Framework, LINQ' },
        { name: 'Php', level: 60, description: 'Laravel, MySQL, RESTful APIs, MVC' },
      ],
    },
    {
      name: 'Tools & Others',
      ...
      skills: [
        ...
        { name: 'Figma', level: 80, description: 'Design tool for creating wireframes, mockups, and prototypes' },
        { name: 'AWS', level: 75, description: 'Cloud services, serverless architecture, S3, EC2, RDS' },
        { name: 'Jupyter', level: 70, description: 'Data analysis, visualization, and machine learning' },
      ],
    },
  ];
